...
public class phylo extends AppCompatActivity {

    int MY_PERMISSION_REQUEST_CALL_PHONE = 1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_phylo);


        CollapsingToolbarLayout collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Philomystics Club");
        ...
        tv.setOnClickListener(
                new Button.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (ActivityCompat.checkSelfPermission(phylo.this,
                                Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(phylo.this, new String[]{Manifest.permission.CALL_PHONE},
    ...
    protected void gotofb(View view) {
        ...
        goToUrl("https://www.facebook.com/coepphilomystics/posts/428521244015774");
    }
    protected void gotoweb(View view) {

        goToUrl("http://www.coep.org.in/clubs/philomystics");
    }
