...
public class Astronomy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbar.setTitle("Astronomy Club");
        ...
        tv.setOnClickListener(
                new Button.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (ActivityCompat.checkSelfPermission(Astronomy.this,
                                Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(Astronomy.this, new String[]{Manifest.permission.CALL_PHONE},
    ...
    protected void gotofb(View view) {
        goToUrl("https://www.facebook.com/coepastronomyclub/");
    }

    protected void gotoyoutube(View view) {
        goToUrl("https://www.youtube.com/watch?v=1TFIZUjI_Wc");
    }

    protected void gotoweb(View view) {
        goToUrl("https://groups.google.com/forum/#!forum/coep-astronomy");
    }
