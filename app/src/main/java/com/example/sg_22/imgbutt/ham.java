...
public class ham extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbar.setTitle("HAM Club");
        ...
        tv.setOnClickListener(
                new Button.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (ActivityCompat.checkSelfPermission(ham.this,
                                Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(ham.this, new String[]{Manifest.permission.CALL_PHONE},
    ...
    protected void gotofb(View view) {
        goToUrl("https://www.facebook.com/VU2COE/");
    }

    protected void gotoweb(View view) {
        goToUrl("http://www.coep.org.in/clubs/ham_club");
    }
