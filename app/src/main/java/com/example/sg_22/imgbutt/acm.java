...
public class acm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbar.setTitle("ACM");
        ...
        tv.setOnClickListener(
                new Button.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (ActivityCompat.checkSelfPermission(acm.this,
                                Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(acm.this, new String[]{Manifest.permission.CALL_PHONE},
    ...
    protected void gotoweb(View view) {
        goToUrl("http://www.coep.org.in/clubs/coep_acm");
    }
