...
public class cofsug extends AppCompatActivity {

    int MY_PERMISSION_REQUEST_CALL_PHONE = 1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cofsug);

        CollapsingToolbarLayout collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("CoFSUG");
        ...
        tv.setOnClickListener(
                new Button.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (ActivityCompat.checkSelfPermission(cofsug.this,
                                Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(cofsug.this, new String[]{Manifest.permission.CALL_PHONE},
    ...
    protected void gotofb(View view) {
        goToUrl("https://www.facebook.com/cofsugpune");
    }

    protected void gotoweb(View view) {
        goToUrl("http://www.coep.org.in/clubs/cofsug");
    }
