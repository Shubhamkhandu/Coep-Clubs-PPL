...
public class NSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbar.setTitle("NSS");
        ...
        tv.setOnClickListener(
                new Button.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (ActivityCompat.checkSelfPermission(NSS.this,
                                Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(NSS.this, new String[]{Manifest.permission.CALL_PHONE},
    ...
    protected void gotofb(View view) {
        goToUrl("https://www.facebook.com/NSS4all/");
    }

    protected void gotoyoutube(View view) {
        goToUrl("https://www.youtube.com/watch?v=8tcWT_JdVIM");
    }

    protected void gotoweb(View view) {
        goToUrl("http://nss.nic.in/");
    }
